...
def _local_answer(query, docs):
    ...
    if "project" in query_lower:
        return (
            ...
            "2. Stock Prediction Portal: this shows applied machine learning, feature engineering, "
            "Django REST APIs, React, dashboards, and financial data analysis.\n"
            "3. Raspberry Pi System Monitoring Dashboard: this shows Python, Django, Linux, system metrics, "
